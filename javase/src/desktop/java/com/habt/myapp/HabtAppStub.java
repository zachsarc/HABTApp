 ...
 * @author Shai Almog
 */
public class HabtAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "HabtApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new HabtAppStub());
    }
